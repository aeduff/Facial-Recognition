...
def get_landmarks(images, labels, save_directory="", num_coords=5, to_save=False):
    ...
    if num_coords == 5:
        predictor_path = r'C:\Users\aeadu\OneDrive\Documents\Mobile Bio Final Project\MobileBiometrics_Project2\shape_predictor_5_face_landmarks.dat'
    else:
        predictor_path = r'C:\Users\aeadu\OneDrive\Documents\Mobile Bio Final Project\MobileBiometrics_Project2\shape_predictor_68_face_landmarks.dat'
